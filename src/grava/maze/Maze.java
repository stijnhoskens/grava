...
public class Maze<V extends Positioned> extends MappedGraph<V, Edge<V>> {
	...
	public Maze(Iterable<V> vertices, Iterable<Edge<V>> edges) {
		super(vertices, edges);
	}

	public Maze(Iterable<V> vertices) {
	...
	public Maze(Graph<V, Edge<V>> graph) {
		super(graph);
	}
	...
	private V neighbor(V v, Direction dir) {
		return posToVertex.get(v.getPosition().neighbor(dir));
	}
